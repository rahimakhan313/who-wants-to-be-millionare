...
def q3():
    ...
    def b():
                b='0'
                if b=='1':
                    button('  $ 300  ',900 , 80 , 200 , 60 ,  golden , green,play )
                    bq4.q4()
                else:
                   score.q3()
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('Complete the series .',350 , 460 , 600 , 40 , golden , golden, play)
            ...
            button(' audiance pole   ',50 , 200 , 200 , 60 ,  golden , golden ,graph.q3)
