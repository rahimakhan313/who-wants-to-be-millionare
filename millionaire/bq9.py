...
def q9():
    ...
    def a():
                a='0'
                if a=='1':
                    button('  $ 1000  ',900 , 80 , 200 , 60 ,  golden , green,play )
                    bq10.q10()
                else:
                    score.q9()
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('select the folded figure',300 , 460 , 600 , 40 , golden , golden,play)
            ...
            button(' audiance pole   ',50 , 200 , 200 , 60 ,  golden , golden ,graph.q9)
