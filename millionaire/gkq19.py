...
def gkq19():
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('The bird which lays more than 100 eggs in one nest is',350 , 460 , 600 , 40 , golden , golden, play)
            button('A-  Cranes ',170 , 550 , 300 , 30 ,  golden , green, a)
            button('B-  trumpeters ',800 , 550 , 300 , 30 ,  golden , green, b)
            button('D-  Ostrich ',800 , 615 , 300 , 30 ,  golden , green, d)
            button('C-  Gulls ',170 , 615 , 300 , 30 ,  golden , green, c)
