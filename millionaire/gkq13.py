...
def gkq13():
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('Which of the following parts of the sun is easily visible only during a total solar eclipse? ',350 , 460 , 600 , 40 , golden , golden, play)
            button('A-  core  ',170 , 550 , 300 , 30 ,  golden , green , a)
            button('B-  photosphere  ',800 , 550 , 300 , 30 ,  golden , green,b )
            button('D-  corona  ',800 , 615 , 300 , 30 ,  golden , green,d )
            button('C-  sunspots   ',170 , 615 , 300 , 30 ,  golden , green ,c)
