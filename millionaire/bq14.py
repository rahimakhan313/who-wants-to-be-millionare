...
def q14():
    ...
    def a():
                a='0'
                if a=='1':
                    button('  $ 1400  ',900 , 80 , 200 , 60 ,  golden , green,play )
                    bq15.q15()
                else:
                    score.q14()
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('You are in a dark room and having only one match . which do you light first?',300 , 460 , 600 , 40 , golden , golden,play)
            button(' A  fire ',170 , 550 , 300 , 30 ,  golden , green ,a)
            button(' B  newspaper ',800 , 550 , 300 , 30 ,  golden , green ,b)
            button(' C  lamp',170 , 615 , 300 , 30 ,  golden , green ,c)
            button(' D  match ',800 , 615 , 300 , 30 ,  golden , green ,d)
