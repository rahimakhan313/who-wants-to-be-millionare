...
def gkq26():
    ...
    crashed = False
    bg = pygame.image.load('paint6.png')
    x = 0
    y = 0
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('Which letter replaces the question mark?',350 , 460 , 600 , 40 , golden , golden, play)
            button('A-  C ',170 , 550 , 300 , 30 ,  golden , green , a)
            button('B-  D ',800 , 550 , 300 , 30 ,  golden , green,b )
            button('D-  E ',800 , 615 , 300 , 30 ,  golden , green,d )
            button('C-  F',170 , 615 , 300 , 30 ,  golden , green ,c)
