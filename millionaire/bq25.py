...
def q25():
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('Mike is butcher . he is 5 foot and 10 inch tall .what does he weight?',300 , 460 , 600 , 40 , golden , golden,play)
            button(' A  height ',170 , 550 , 300 , 30 ,  golden , green ,a)
            button(' B  bones ',800 , 550 , 300 , 30 ,  golden , green ,b)
            button(' C  none',170 , 615 , 300 , 30 ,  golden , green ,c)
            button(' D  meat ',800 , 615 , 300 , 30 ,  golden , green ,d)
