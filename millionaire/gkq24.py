...
def gkq24():
    ...
    crashed = False
    bg = pygame.image.load('paint4.png')
    x = 0
    y = 0
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('What are the missing numbers?',350 , 460 , 600 , 40 , golden , golden, play)
            button('A-  7 and 3 ',170 , 550 , 300 , 30 ,  golden , green , a)
            button('B-  4 and 10 ',800 , 550 , 300 , 30 ,  golden , green,b )
            button('D-  6 and 5 ',800 , 615 , 300 , 30 ,  golden , green,d )
            button('C-  9 and 11 ',170 , 615 , 300 , 30 ,  golden , green ,c)
