...
def q20():
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('what does this rebus mean?',300 , 460 , 600 , 40 , golden , golden,play)
            button(' A  friend"s circle ',170 , 550 , 300 , 30 ,  golden , green ,a)
            button(' B  friends forever ',800 , 550 , 300 , 30 ,  golden , green ,b)
            button(' C  all',170 , 615 , 300 , 30 ,  golden , green ,c)
