...
def q13():
    ...
    def a():
                a='0'
                if a=='1':
                    button('  $ 1300  ',900 , 80 , 200 , 60 ,  golden , green,play )
                    bq14.q14()
                else:
                    score.q13()
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('Once in a year , twice in a week and never in a day?',300 , 460 , 600 , 40 , golden , golden,play)
            button(' A  Eid ',170 , 550 , 300 , 30 ,  golden , green ,a)
            button(' B  Exam ',800 , 550 , 300 , 30 ,  golden , green ,b)
            button(' C  Alphabet',170 , 615 , 300 , 30 ,  golden , green ,c)
