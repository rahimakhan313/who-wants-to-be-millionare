...
def q8():
    ...
    def b():
                b='0'
                if b=='1':
                    button('  $ 800  ',900 , 80 , 200 , 60 ,  golden , green,play )
                    bq9.q9()
                else:
                    score.q8()
                    amount.q1()
    ...
    def game_intro():
        ...
        while intro:
            ...
            button('5 , 1 , 6 , 2 ,  7,  ____?',300 , 460 , 600 , 40 , golden , golden,play)
            button(' A  3 ',170 , 550 , 300 , 30 ,  golden , green ,a)
            button(' B  8 ',800 , 550 , 300 , 30 ,  golden , green ,b)
